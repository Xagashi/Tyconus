...
---------------------------------------------------------------------------------------------------------------
	...
	sets.midcast.conservemp = { --43 base + 6+6+3+10+7+15+5+9+12=116
	main="Solstice", --6
	head="Vanya Hood", --6
	right_ear="Gifted Earring", --3
	body="Vedic Coat", --10
	hands="Shrieker's Cuffs", --7
	right_ring="Mephitas's Ring +1", --15
	...
	main={name="Idris",priority=15},
	neck={name="Bagua Charm +2",priority=14},
	hands="Geomancy Mitaines +3",
	left_ring={name="Stikini Ring +1", bag="wardrobe1"},
    right_ring={name="Stikini Ring +1", bag="wardrobe2"},
	})
...
---------------------------------------------------------------------------------------------------------------
	...
	sets.pet ={ --PetDT/Regen 39/27 --+2R25 neck = -23 perpetuation cost bubble BoG/EA
	main="Idris", --25/0
	sub="Genmei Shield",
